...
import com.example.srt_droid.Pesanan.UbahPesananActivity;
...
public class TabMenuTersedia extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tab_menu_tersedia);
	...
	private void showDialog(final MenuResto menu) {
		...
		ubah.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				menuController.ubahKetersediaan(menu, 0);
				Toast.makeText(getApplicationContext(), "Ketersediaan " + menu.getNama() + " telah diubah menjadi kosong", Toast.LENGTH_LONG).show();
				dialog.cancel();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tab_menu_tersedia, menu);
		return true;
	}
